...
class SDXL2Parallel():
    def __init__(
        ...
        if self.parallel == True:
            ...
            process = multiprocessing.Process(target=parallel_manager, args=(child_pipe, unet_path, device_id,))
            process.start()
            ...
            process2 = multiprocessing.Process(target=parallel_manager, args=(child_pipe2, unet_path,device_id+1,))
            process2.start()
    ...
    def run_unet1(self,inputs1,t:list):
        # print time 
        res = self.unet(inputs1)
        t.append(res)
    
    def run_unet2(self,inputs2, t:list):
        res = self.unet2(inputs2)
        t.append(res)
    ...
    def run_unet(self, inputs):
        ...
        inputs1 = [ inputss[0][0].unsqueeze(0), inputss[1], inputss[2][0].unsqueeze(0), inputss[3][0].unsqueeze(0), inputss[4][0].unsqueeze(0)  ]
        inputs2 = [ inputss[0][1].unsqueeze(0), inputss[1], inputss[2][1].unsqueeze(0), inputss[3][1].unsqueeze(0), inputss[4][1].unsqueeze(0)  ]
...
if __name__ == "__main__":
    ...
    pipe = StableDiffusionXLPipeline(
            vae_encoder_path='/workspace/aa/sdxl/models/vae_encoder_fp32_1684x_bf16.bmodel', # vae_encoder_1684x_bf16.bmodel',
            # vae_decoder_path='/workspace/aa/sdxl/models/vae_decoder_1684x_bf16_2.bmodel',
            vae_decoder_path = "/workspace/zxh_workspace/xl_models/vae_decoder_taesdxl_float16_1024_1024.bmodel",
            text_encoder_path='/workspace/aa/sdxl/models/text_encoder_1684x_f32.bmodel',
            text_encoder_2_path='/workspace/aa/sdxl/models/text_encoder_2_1684x_f32.bmodel',
            tokenizer_path='/workspace/aa/sdxl/models/tokenizer',
            tokenizer_2_path='/workspace/aa/sdxl/models/tokenizer_2',
            unet_path='/workspace/demos/onebatch/models/basic/unet.bmodel',
            parallel=True
            )

    prompt = "happy young girl, cute, 8K, HD"
    image0 = pipe(prompt,
                num_inference_steps = 20)
    image0.save('girl_txt2img2.png')
    # 销毁 
