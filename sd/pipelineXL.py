...
if __name__ == "__main__":
    ...
    scheduler = EulerDiscreteScheduler(**scheduler_dict)

    pipe = StableDiffusionXLPipeline(
            vae_encoder_path='./xl_models/vae_encoder_fp32_1684x_bf16.bmodel', # vae_encoder_1684x_bf16.bmodel',
            vae_decoder_path='./xl_models/vae_decoder_1684x_bf16_2.bmodel',
            text_encoder_path='./xl_models/text_encoder_1684x_f32.bmodel',
            text_encoder_2_path='./xl_models/text_encoder_2_1684x_f32.bmodel',
            tokenizer_path='./xl_models/tokenizer',
            tokenizer_2_path='./xl_models/tokenizer_2',
            unet_path='./xl_models/unet.bmodel')

    prompt = "happy young girl, cute, 8K, HD"
    image0 = pipe(prompt,
                num_inference_steps = 20)
    image0.save('girl_txt2img.png')
